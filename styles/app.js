...
let sumArrowFun = (a, b, c, d) => a + b + c + d;
console.log("***my arrow fun ****",sumArrowFun(1, 2, 3, 4));
/*--------------------------arrow function 1-----------------------------------*/
...
console.log("***my arrow fun ****", objectLitArrowFun());
...
let sumAndProductArrowFun = (a, b) => {
  let sum = a + b;
  let product = a * b;
  return [sum, product];
};
console.log("***my arrow fun ****", sumAndProductArrowFun(3,9));
/*--------------------------arrow function 3-----------------------------------*/
...
let messageArrowFun = name => `Hello, ${name}!`;

console.log("***my arrow fun ****", messageArrowFun('Allie'));
/*--------------------------arrow function 4-----------------------------------*/
...
// let StudentArrowFun = (name, age, hometown) => {
//   this.name = name;
//   this.age = age;
//   this.hometown = hometown;
// };

// let areej = new StudentArrowFun('areej', 'Schmoe', 100);

// console.log("***By my arrow fun ****", areej);
/*--------------------------arrow function 5-----------------------------------*/
...
// window obj (the closest non-arrow parent function)
